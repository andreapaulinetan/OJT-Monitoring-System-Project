    ...
    <body>
            ...
            <main class="main-content">
                <header class="top-bar">
                    ...
                    <div class="search-container">
                        <input type="text" id="internSearch" class="search-input" placeholder="Search by name, ID, or role..." onkeyup="filterTable()">
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="data-table" id="internTable">
                            ...
                            <tbody id="internTableBody">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center">No interns found in the database.</td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
        ...
        <script>
            ...
            function populateDropdowns() {
                ...
                rows.forEach(row => {
                    data.uni.add(row.querySelector(".col-uni").innerText.trim());
                    data.role.add(row.querySelector(".col-role").innerText.trim());
                    data.office.add(row.querySelector(".col-office").innerText.trim());
                    data.status.add(row.querySelector(".col-status span").textContent.trim());
                });
